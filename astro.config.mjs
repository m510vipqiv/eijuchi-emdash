...
export default defineConfig({
	...
	integrations: [
		...
		emdash({
			...
			plugins: [
				formsPlugin(),
				// Outbound mail via the Email Routing `send_email` binding (free for
				// verified destination addresses). Sender domain: eijuchi.com.
				cloudflareEmail({ from: { email: "noreply@eijuchi.com", name: "永住地" } }),
			],
